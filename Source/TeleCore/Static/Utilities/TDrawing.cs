...
namespace TeleCore
{
    ...
    {
        public static void Draw(Graphic graphic, Vector3 drawPos, Rot4 rot, float? rotation, ThingDef def, Thing thing = null, FXDefExtension extension = null)
        {
            FXLayer.GetDrawInfo(graphic, thing, def,  ref drawPos, rot, extension, out _, out var drawMat, out var drawMesh, out var exactRotation, out _);
        ...
        public static void Print(SectionLayer layer, Graphic graphic, ThingWithComps thing, ThingDef def, FXDefExtension extension = null)
        {
            ...
            FXLayer.GetDrawInfo(graphic, thing, def, ref drawPos, thing.Rotation, extension, out var drawSize, out var drawMat, out _, out var exactRotation, out var flipUV);
            Printer_Plane.PrintPlane(layer, drawPos, drawSize, drawMat, exactRotation, flipUV, null, null, 0.01f, 0f);
