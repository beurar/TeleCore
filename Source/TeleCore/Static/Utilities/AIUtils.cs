...
{
    public static void RoomsAlongPath(this List<IntVec3> pathNodes, ref List<Room> roomList, Map map,
    ...
    public static void RoomsAlongPath(this List<IntVec3> pathNodes, ref List<RoomTracker> roomList, Map map,
        bool ignoreDoorWays = true, bool reverse = false, RoomRoleDef withRole = null)
    {
        roomList.Clear();
        Room lastAddedRoom = null;
    ...
    public static PawnPathResult TryGetPath(IntVec3 start, LocalTargetInfo destination, Map map,
