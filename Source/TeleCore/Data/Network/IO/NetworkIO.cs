...
public class NetworkIO
{
    ...
    public NetworkIO(string pattern, Thing thing)
    {
    ...
    {
        input = input.Replace("|", "");
        MatchCollection matches = Regex.Matches(input,  IOUtils.RegexPattern);
    ...
    internal static string DefaultFallbackIfNecessary(string pattern, IntVec2 size)
    {
        ...
        for (int x = 0; x < widthx; x++)
        {
            ...
            {
                charArr[x + (y * widthx)] = IOUtils.TwoWay;
            }
        }
    ...
    public IOConnectionResult ConnectsTo(NetworkIO otherGeneralIO)
    {
    ...
    private IOConnectionResult SubMatch(IntVec3Rot cell, NetworkIO other)
    {
