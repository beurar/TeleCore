...
namespace TeleCore
{
    public struct KeyFrameData : IExposable
    {
        ...
        {
            return rotation.Equals(other.rotation) && position.Equals(other.position) && size.Equals(other.size) && pivotPoint.Equals(other.pivotPoint) && texCoordsData.Equals(other.texCoordsData);
        }
