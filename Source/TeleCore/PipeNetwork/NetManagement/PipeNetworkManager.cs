...
namespace TeleCore
{
    ...
    public class PipeNetworkManager
    {
        ...
        private Map map;
        private PipeNetwork[] lookUpGrid;

        //
        private List<PipeNetwork> allNetworks;
        ...
        public void Notify_PipeNetCreated(PipeNetwork newNetwork)
        {
            ...
            for (int i = 0; i < newNetwork.NetworkCells.Count; i++)
            {
                ...
                list.Add(cell);
                map.mapDrawer.MapMeshDirty(cell, MapMeshFlag.Buildings | MapMeshFlag.Things | MapMeshFlag.PowerGrid | MapMeshFlag.Terrain);
            }
        }
